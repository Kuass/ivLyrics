...
window.LANG_JA = {
  ...
  "settings": {
    ...
    "culturalAnnotations": {
      "label": "文化的背景の解説",
      "desc": "翻訳だけでは伝わりにくい文化的背景がある歌詞の行にのみ、AIによる解説を表示します。翻訳先の言語を使用します。通常の歌詞ページと通常の全画面表示にのみ表示され、LPモードとパネル歌詞には表示されません。",
  ...
  "menu": {
    ...
    "regenerateTranslationOptionsSubtitle": "発音と翻訳の両方が有効です。再生成する項目を選択してください。",
