...
window.LANG_KO = {
  ...
  "settings": {
    ...
    "culturalAnnotations": {
      "label": "문화적 배경 설명",
      "desc": "번역만으로 이해하기 어려운 문화적 배경이 있는 가사 줄 아래에만 AI 설명을 표시합니다. 번역 대상 언어를 사용합니다. 일반 가사 페이지와 일반 전체화면에서만 표시되며, LP 모드와 패널 가사에는 표시되지 않습니다.",
  ...
  "menu": {
    ...
    "regenerateTranslationOptionsSubtitle": "발음과 번역이 모두 켜져 있습니다. 다시 만들 항목을 선택하세요.",
