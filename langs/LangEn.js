...
window.LANG_EN = {
  ...
  "menu": {
    ...
    "regenerateTranslationOptionsSubtitle": "Pronunciation and translation are both enabled. Choose what to rebuild.",
  ...
  "syncCreator": {
    ...
    "historyEmpty": "A checkpoint will be saved here whenever you complete a line.",
    ...
    "characterPronunciationDesc": "Generate Korean pronunciation for each character with AI and show it below the current line.",
