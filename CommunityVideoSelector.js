...
const getCommunityVideoSelectionInfo = (video, startTime = video?.startTime) => ({
...
const CommunityVideoSelector = ({
  ...
  const applyVideoSelection = useCallback((video, options = {}) => {
    ...
    onVideoSelect?.(getCommunityVideoSelectionInfo(video, options.startTime));
      ...
      if (result) {
        ...
        if (shouldApplyUpdatedSelection) {
          applyVideoSelection(
            ...
            { startTime: normalizedStartTime, notify: false }
          );
        }
        Toast.success(
          wasUpdated
